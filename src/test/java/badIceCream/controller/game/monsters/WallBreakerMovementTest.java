...
public class WallBreakerMovementTest {
    private WallBreakerMovement movement;
    ...
    @BeforeEach
    public void setup() {
        movement = new WallBreakerMovement();
        monster = new WallBreakerMonster(1, 1);
    ...
    @Test
    public void ensureWallBreakerBreaksIceWall() throws Exception {
        Monster blockingMonsterUp = new DefaultMonster(1, 0);
        Monster blockingMonsterDown = new DefaultMonster(1, 2);
        Monster blockingMonsterLeft = new DefaultMonster(0, 1);
        ArrayList<Wall> walls = new ArrayList<>();
        IceWall iceWall = new IceWall(2, 1);
        walls.add(iceWall);
        ...
        movement.step(monster, arena, LONG_TIME_ELAPSED, LAST_MOVEMENT);
        assertFalse(arena.isIceWall(new Position(2, 1)));
