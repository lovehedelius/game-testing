...
public class RunnerMovementEnabledTest {
    private RunnerMovementEnabled movement;
    ...
    @BeforeEach
    public void setup() {
        movement = new RunnerMovementEnabled();
        monster = new RunnerMonster(1, 1);
    ...
    @Test
    public void testStepWhenStandingOnIceCream() throws Exception {
        arena.setWalls(new ArrayList<>());
        arena.setMonsters(Collections.singletonList(monster));
